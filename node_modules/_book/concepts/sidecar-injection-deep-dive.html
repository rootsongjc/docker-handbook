...
<html lang="zh-hans" >
    <head>
        ...
        <title>Istio 中的 Sidecar 注入与流量劫持详解 · Istio Handbook - Istio 服务网格进阶实战 by Jimmy Song(宋净超)</title>
    ...
    <link rel="next" href="istio-sidecar-injector.html" />
    
    
    <link rel="prev" href="sidecar-pattern.html" />
...
<ul class="summary">
    ...
    <li class="divider"></li>
        ...
        <li class="chapter active" data-level="2.3.1" data-path="sidecar-injection-deep-dive.html">
        ...
        <li class="chapter " data-level="2.4.1" data-path="traffic-management-basic.html">
...
<div class="book-header" role="navigation">
    ...
    <h1>
        ...
        <a href=".." >Istio 中的 Sidecar 注入与流量劫持详解</a>
    </h1>
</div>
...
<div class="search-plus" id="book-search-results">
    <div class="search-noresults">
                                ...
                                <h1 id="istio-&#x4E2D;&#x7684;-sidecar-&#x6CE8;&#x5165;&#x4E0E;&#x6D41;&#x91CF;&#x52AB;&#x6301;&#x8BE6;&#x89E3;">Istio &#x4E2D;&#x7684; Sidecar &#x6CE8;&#x5165;&#x4E0E;&#x6D41;&#x91CF;&#x52AB;&#x6301;&#x8BE6;&#x89E3;</h1>
...
<pre class="language-"><code class="lang-bash">-p <span class="token number">15001</span> -u <span class="token number">1337</span> -m REDIRECT -i <span class="token string">&apos;*&apos;</span> -x <span class="token string">&quot;&quot;</span> -b <span class="token number">9080</span> -d <span class="token string">&quot;&quot;</span>
</code></pre>
...
<pre class="language-"><code class="lang-bash">$ istio-iptables.sh -p PORT -u <span class="token environment constant">UID</span> -g GID <span class="token punctuation">[</span>-m mode<span class="token punctuation">]</span> <span class="token punctuation">[</span>-b ports<span class="token punctuation">]</span> <span class="token punctuation">[</span>-d ports<span class="token punctuation">]</span> <span class="token punctuation">[</span>-i CIDR<span class="token punctuation">]</span> <span class="token punctuation">[</span>-x CIDR<span class="token punctuation">]</span> <span class="token punctuation">[</span>-h<span class="token punctuation">]</span>
...
<pre class="language-"><code class="lang-bash">$ /usr/local/bin/istio-iptables.sh -p <span class="token number">15001</span> -u <span class="token number">1337</span> -m REDIRECT -i <span class="token string">&apos;*&apos;</span> -x <span class="token string">&quot;&quot;</span> -b <span class="token number">9080</span> -d <span class="token string">&quot;&quot;</span>
</code></pre>
...
<pre class="language-"><code class="lang-bash">$ kubectl -n default get pod -l <span class="token assign-left variable">app</span><span class="token operator">=</span>productpage -o wide
NAME                              READY     STATUS    RESTARTS   AGE       IP             NODE
productpage-v1-745ffc55b7-2l2lw   <span class="token number">2</span>/2       Running   <span class="token number">0</span>          1d        <span class="token number">172.33</span>.78.10   node3
</code></pre>
...
<figure id="fig2.3.1.1"><a href="../images/0069RVTdly1fv5hukl647j30k6145gnt.jpg" data-lightbox="c828d2bd-71c2-4289-9e7c-9a00846207a0" data-title="iptables &#x8C03;&#x7528;&#x94FE;"><img src="../images/0069RVTdly1fv5hukl647j30k6145gnt.jpg" alt="iptables &#x8C03;&#x7528;&#x94FE;"></a><figcaption>&#x56FE;&#x7247; - iptables &#x8C03;&#x7528;&#x94FE;</figcaption></figure>
...
<figure id="fig2.3.1.2"><a href="../images/0069RVTdgy1fv5dq2bptdj31110begnl.jpg" data-lightbox="2e0cb145-2e23-46dd-a37a-8ee4263bea83" data-title="iptables &#x8C03;&#x7528;&#x94FE;"><img src="../images/0069RVTdgy1fv5dq2bptdj31110begnl.jpg" alt="iptables &#x8C03;&#x7528;&#x94FE;"></a><figcaption>&#x56FE;&#x7247; - iptables &#x8C03;&#x7528;&#x94FE;</figcaption></figure>
...
<figure id="fig2.3.1.3"><a href="../images/0069RVTdgy1fv5dm4a9ygj30w50czdi3.jpg" data-lightbox="be1891a6-fee7-4549-96be-70f5c5f4659a" data-title="iptables&#x7ED3;&#x6784;&#x56FE;"><img src="../images/0069RVTdgy1fv5dm4a9ygj30w50czdi3.jpg" alt="iptables&#x7ED3;&#x6784;&#x56FE;"></a><figcaption>&#x56FE;&#x7247; - iptables&#x7ED3;&#x6784;&#x56FE;</figcaption></figure>
...
<figure id="fig2.3.1.4"><a href="../images/envoy-sidecar-traffic-interception-20190111.png" data-lightbox="64be5728-7691-4e3f-bdb4-3f71ccc97ae1" data-title="Envoy sidecar &#x6D41;&#x91CF;&#x52AB;&#x6301;&#x6D41;&#x7A0B;&#x793A;&#x610F;&#x56FE;"><img src="../images/envoy-sidecar-traffic-interception-20190111.png" alt="Envoy sidecar &#x6D41;&#x91CF;&#x52AB;&#x6301;&#x6D41;&#x7A0B;&#x793A;&#x610F;&#x56FE;"></a><figcaption>&#x56FE;&#x7247; - Envoy sidecar &#x6D41;&#x91CF;&#x52AB;&#x6301;&#x6D41;&#x7A0B;&#x793A;&#x610F;&#x56FE;</figcaption></figure>
...
Chain ISTIO_IN_REDIRECT <span class="token punctuation">(</span><span class="token number">1</span> references<span class="token punctuation">)</span>
 pkts bytes target     prot opt <span class="token keyword">in</span>     out     <span class="token builtin class-name">source</span>               destination
    <span class="token number">2</span>   <span class="token number">120</span> REDIRECT   tcp  --  any    any     anywhere             anywhere             redir ports <span class="token number">15001</span>
...
<figure id="fig2.3.1.5"><a href="../images/006tNbRwly1fv92uvxu4dj31320giq6u.jpg" data-lightbox="04ce46bb-c6b2-4829-9785-97eae67b9e09" data-title="istio sidecar iptables &#x6CE8;&#x5165;"><img src="../images/006tNbRwly1fv92uvxu4dj31320giq6u.jpg" alt="istio sidecar iptables &#x6CE8;&#x5165;"></a><figcaption>&#x56FE;&#x7247; - istio sidecar iptables &#x6CE8;&#x5165;</figcaption></figure>
...
<pre class="language-"><code class="lang-bash">/usr/local/bin/envoy -c /etc/istio/proxy/envoy-rev0.json --restart-epoch <span class="token number">0</span> --drain-time-s <span class="token number">45</span> --parent-shutdown-time-s <span class="token number">60</span> --service-cluster productpage --service-node sidecar~172.33.78.10~productpage-v1-745ffc55b7-2l2lw.default~default.svc.cluster.local --max-obj-name-len <span class="token number">189</span> -l warn --v2-config-only
</code></pre>
<p>&#x6211;&#x4EEC;&#x5206;&#x522B;&#x89E3;&#x91CA;&#x4E0B;&#x4EE5;&#x4E0A;&#x914D;&#x7F6E;&#x7684;&#x610F;&#x4E49;&#x3002;</p>
<ul>
...
<figure id="fig2.3.1.6"><a href="../images/0069RVTdgy1fv5df9lq1aj317o0o6wia.jpg" data-lightbox="e7b454a1-115e-48d2-b426-960799afaf5e" data-title="Istio bookinfo"><img src="../images/0069RVTdgy1fv5df9lq1aj317o0o6wia.jpg" alt="Istio bookinfo"></a><figcaption>&#x56FE;&#x7247; - Istio bookinfo</figcaption></figure>
...
envoy    <span class="token number">11</span> istio-proxy    9u  IPv4  <span class="token number">73951</span>      0t0  TCP localhost:15000 <span class="token punctuation">(</span>LISTEN<span class="token punctuation">)</span> <span class="token comment"># Envoy admin &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   17u  IPv4  <span class="token number">74320</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:46862-<span class="token operator">&gt;</span>istio-pilot.istio-system.svc.cluster.local:15010 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># 15010&#xFF1A;istio-pilot &#x7684; grcp-xds &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   18u  IPv4  <span class="token number">73986</span>      0t0  UDP productpage-v1-745ffc55b7-2l2lw:44332-<span class="token operator">&gt;</span>istio-statsd-prom-bridge.istio-system.svc.cluster.local:9125 <span class="token comment"># &#x7ED9; Promethues &#x53D1;&#x9001; metric &#x7684;&#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   52u  IPv4  <span class="token number">74599</span>      0t0  TCP *:15001 <span class="token punctuation">(</span>LISTEN<span class="token punctuation">)</span> <span class="token comment"># Envoy &#x7684;&#x76D1;&#x542C;&#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   53u  IPv4  <span class="token number">74600</span>      0t0  UDP productpage-v1-745ffc55b7-2l2lw:48011-<span class="token operator">&gt;</span>istio-statsd-prom-bridge.istio-system.svc.cluster.local:9125 <span class="token comment"># &#x7ED9; Promethues &#x53D1;&#x9001; metric &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   54u  IPv4 <span class="token number">338551</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:15001-<span class="token operator">&gt;</span><span class="token number">172.17</span>.8.102:52670 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># 52670&#xFF1A;Ingress gateway &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   55u  IPv4 <span class="token number">338364</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:44046-<span class="token operator">&gt;</span><span class="token number">172.33</span>.78.9:9091 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># 9091&#xFF1A;istio-telemetry &#x670D;&#x52A1;&#x7684; grpc-mixer &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   56u  IPv4 <span class="token number">338473</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:47210-<span class="token operator">&gt;</span>zipkin.istio-system.svc.cluster.local:9411 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># 9411: zipkin &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   58u  IPv4 <span class="token number">338383</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:41564-<span class="token operator">&gt;</span><span class="token number">172.33</span>.84.8:9080 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># 9080&#xFF1A;details-v1 &#x7684; http &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   59u  IPv4 <span class="token number">338390</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:54410-<span class="token operator">&gt;</span><span class="token number">172.33</span>.78.5:9080 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># 9080&#xFF1A;reivews-v2 &#x7684; http &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   60u  IPv4 <span class="token number">338411</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:35200-<span class="token operator">&gt;</span><span class="token number">172.33</span>.84.5:9091 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># 9091:istio-telemetry &#x670D;&#x52A1;&#x7684; grpc-mixer &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   62u  IPv4 <span class="token number">338497</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:34402-<span class="token operator">&gt;</span><span class="token number">172.33</span>.84.9:9080 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># reviews-v1 &#x7684; http &#x7AEF;&#x53E3;</span>
envoy    <span class="token number">11</span> istio-proxy   63u  IPv4 <span class="token number">338525</span>      0t0  TCP productpage-v1-745ffc55b7-2l2lw:50592-<span class="token operator">&gt;</span><span class="token number">172.33</span>.71.5:9080 <span class="token punctuation">(</span>ESTABLISHED<span class="token punctuation">)</span> <span class="token comment"># reviews-v3 &#x7684; http &#x7AEF;&#x53E3;</span>
</code></pre>
<p>&#x4ECE;&#x8F93;&#x51FA;&#x7EA7;&#x8FC7;&#x4E0A;&#x53EF;&#x4EE5;&#x9A8C;&#x8BC1; Sidecar &#x662F;&#x5982;&#x4F55;&#x63A5;&#x7BA1;&#x6D41;&#x91CF;&#x548C;&#x4E0E; istio-pilot &#x901A;&#x4FE1;&#xFF0C;&#x53CA;&#x5411; Mixer &#x505A;&#x9065;&#x6D4B;&#x6570;&#x636E;&#x6C47;&#x805A;&#x7684;&#x3002;&#x611F;&#x5174;&#x8DA3;&#x7684;&#x8BFB;&#x8005;&#x53EF;&#x4EE5;&#x518D;&#x53BB;&#x770B;&#x770B;&#x5176;&#x4ED6;&#x51E0;&#x4E2A;&#x670D;&#x52A1;&#x7684; istio-proxy &#x5BB9;&#x5668;&#x4E2D;&#x7684; iptables &#x548C;&#x7AEF;&#x53E3;&#x4FE1;&#x606F;&#x3002;</p>
<h2 id="&#x53C2;&#x8003;">&#x53C2;&#x8003;</h2>
<ul>
<li><a href="https://jimmysong.io/posts/sofamesh-and-mosn-proxy-sidecar-service-mesh-by-ant-financial" target="_blank">SOFAMesh &amp; SOFA MOSN&#x2014;&#x57FA;&#x4E8E;Istio&#x6784;&#x5EFA;&#x7684;&#x7528;&#x4E8E;&#x5E94;&#x5BF9;&#x5927;&#x89C4;&#x6A21;&#x6D41;&#x91CF;&#x7684;Service Mesh&#x89E3;&#x51B3;&#x65B9;&#x6848; - jimmysong.io</a></li>
    ...
    <div class="search-results">
        ...
        <div class="no-results">
            ...
            <h1 class="search-results-title">No results matching "<span class='search-query'></span>"</h1>
                ...
                <a href="sidecar-pattern.html" class="navigation navigation-prev " aria-label="Previous page: Sidecar 模式">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="istio-sidecar-injector.html" class="navigation navigation-next " aria-label="Next page: Sidecar 的自动注入过程详解">
